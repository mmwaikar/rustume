...
Define the screenshot-aligned visual composition for the Profile section while preserving the candidate data and links already supplied by JSON Resume.
